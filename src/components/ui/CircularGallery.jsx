...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.plane.scale.y = (this.viewport.height * (1170 * this.scale)) / this.screen.height;
    this.plane.scale.x = (this.viewport.width * (910 * this.scale)) / this.screen.width;
...
export default function CircularGallery({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Testimonial gallery. Drag or scroll to browse."
    />
  );
}
